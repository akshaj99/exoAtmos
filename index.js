...
function onDocumentMouseClick(event) {
    ...
    if (intersects.length > 0) {
        ...
        if (idx) updateExoplanetPage(idx);
        else updateExoplanetPage(0);
...
let exoplanetName = document.getElementById('exoplanetName');
let exoplanetName2 = document.getElementById('exoplanetName2');
let exoplanetNames = document.getElementById('exoplanetNames');
let exoplanetDist = document.getElementById('exoplanetDist');

let exoplanetColor = document.getElementById('exoplanetColor');
...
function updateExoplanetPage(i) {
    let name = names[i];

    if (i === 0) {
        exoplanetName.innerText = 'Earth';
        exoplanetName2.innerText = 'Earth';
        exoplanetNames.innerText = 'Earth';
        ...
        if (typeof A !== 'undefined') {
            ...
            image.src = 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/City_Lights_of_Asia_and_Middle_East_2016.png/640px-City_Lights_of_Asia_and_Middle_East_2016.jpg';
        ...
        exoplanetName.innerText = firstname;
        exoplanetName2.innerText = firstname;
        exoplanetNames.innerText = name;
    ...
    let exoplanetDistance = to.length();
    exoplanetDist.innerText = `${exoplanetDistance.toFixed(1)} Mpc (${(3.262 * exoplanetDistance).toFixed(1)} Mly)`;
